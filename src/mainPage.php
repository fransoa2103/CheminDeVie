...
<?php
    ...
    PierreDeVoeuxBaseSommet::pierreDeVoeuxBaseSommet(
        $bracelet->nomsTableau,
        $bracelet->resultat_pierreDeVoeux,
        $bracelet->resultat_pierreDeBase,
        $bracelet->valeur_pierreDeBase,
        $bracelet->resultat_pierreDeSommet,
        $bracelet->valeur_pierreDeSommet
    );
    // $bracelet->pierreDappel();
    ...
    echo '</br>Vous êtes né(e) le: '.$bracelet->dateNaissance[2].'-'.$bracelet->dateNaissance[1].'-'.$bracelet->dateNaissance[0].'</br>';
